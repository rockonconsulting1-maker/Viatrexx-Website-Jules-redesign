...
## 2026-02-13 - Low: Accessibility & UX Improvements (Experience)
- Injected global high-visibility focus ring styles for better keyboard navigation.
- Added aria-labels to mobile menu and social links.
- Corrected header z-index to prevent overlapping issues on mobile.
- Normalized root-level asset paths by removing redundant "../" prefixes.
